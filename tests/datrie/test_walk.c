 ...
 */
DictRec walk_dict[] = {
    {(AlphaChar *)"pool",       TRIE_DATA_UNREAD},
    {(AlphaChar *)"prize",      TRIE_DATA_UNREAD},
    {(AlphaChar *)"preview",    TRIE_DATA_UNREAD},
    {(AlphaChar *)"prepare",    TRIE_DATA_UNREAD},
    {(AlphaChar *)"produce",    TRIE_DATA_UNREAD},
    {(AlphaChar *)"progress",   TRIE_DATA_UNREAD},
